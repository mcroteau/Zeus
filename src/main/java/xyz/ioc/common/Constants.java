...
public class Constants {
    ...
    public static final String PROFILE_IMAGE_DIRECTORY = "media/accounts/";

    public static final String FRESCO            = "media/accounts/sebastien.jpg";
	public static final String DEFAULT_IMAGE_URI = "media/accounts/zeus.png";
